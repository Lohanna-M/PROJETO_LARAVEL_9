@extends('layouts.default') //extensão para a header e footer
@section('content') //nome da seção onde está
                    ...
                    <div class="p-2 w-full">
                        <div class="relative">
                            ...
                            <textarea
                                ...
                                class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">{{ old('name') }}</textarea>
                        </div>
                        @error('description')
                            <div class="text-red-400 text-sm">{{ $message }}</div>
                        @enderror
